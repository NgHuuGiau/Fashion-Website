    ...
    def _create_faqs(self):
        faqs = [
            ...
            (
                ...
                "giao hàng thời gian",
                "Giao hàng nội thành TP.HCM: 1-2 ngày làm việc. Các tỉnh thành khác: 3-7 ngày làm việc.",
                20,
            ),
            (
                "Tôi có thể hủy đơn hàng không?",
                "hủy đơn hàng",
                "Bạn có thể hủy đơn hàng trong vòng 24h kể từ khi đặt hàng. Sau thời gian này, vui lòng liên hệ CSKH để được hỗ trợ.",
                30,
            ),
            (
                "Phương thức thanh toán nào được hỗ trợ?",
                "thanh toán",
                "Chúng tôi hỗ trợ thanh toán khi nhận hàng (COD) và chuyển khoản ngân hàng.",
                40,
            ),
        ]

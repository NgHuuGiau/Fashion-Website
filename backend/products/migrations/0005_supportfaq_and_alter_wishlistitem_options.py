...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={
                "ordering": ["-created"],
                "verbose_name": "Sáº£n pháº©m yĂªu thĂ­ch",
                "verbose_name_plural": "Sáº£n pháº©m yĂªu thĂ­ch",
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("question", models.CharField(max_length=255, verbose_name="CĂ¢u há»i")),
                ("keywords", models.CharField(blank=True, max_length=255, verbose_name="Tá»« khĂ³a")),
                ("answer", models.TextField(verbose_name="CĂ¢u tráº£ lá»i")),
                ("priority", models.PositiveSmallIntegerField(default=100, verbose_name="Äá»™ Æ°u tiĂªn")),
                ("is_active", models.BooleanField(default=True, verbose_name="Äang dĂ¹ng")),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
            ],
            options={
                "verbose_name": "FAQ há»— trá»£",
                "verbose_name_plural": "FAQ há»— trá»£",

...
class ReferralCodeAdmin(admin.ModelAdmin):
    list_display = ("code", "user", "is_active", "usage_count", "max_usage", "created_at", "expires_at")
...
class ReferralRewardAdmin(admin.ModelAdmin):
    list_display = ("referral_code", "referrer", "referred_user", "reward_type", "amount", "is_claimed", "created_at")

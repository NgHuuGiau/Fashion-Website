...
api_urlpatterns = [
    ...
    path(
        ...
        api.api_product_reviews,
        name="api_product_reviews",
    ),
    path(
        "products/<int:pk>/reviews/create/",
        api.api_review_submit,
        name="api_review_submit",
    ),
    ...
    path(
        "admin/orders/<int:pk>/",
        api.api_admin_order_detail,
        name="api_admin_order_detail",
    ),
    path(
        "admin/orders/<int:pk>/status/",
        api.api_admin_order_status,
        name="api_admin_order_status",
    ),
    path(
        "admin/orders/<int:pk>/refund/",
        api.api_admin_order_refund,
        name="api_admin_order_refund",
    ),
    path(
        "admin/orders/<int:pk>/invoice/",
        api.api_admin_invoice,
        name="api_admin_invoice",
    ),

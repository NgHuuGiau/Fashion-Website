...
Locator: locator('.alert-danger, .error, .messages .error')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.alert-danger, .error, .messages .error') with timeout 5000ms
  - waiting for locator('.alert-danger, .error, .messages .error')

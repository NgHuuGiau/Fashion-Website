...
- Name: payment.spec.ts >> Payment Flows >> should show QR code for bank transfer
- Location: tests\payment.spec.ts:70:7
...
Received string:  "http://localhost:8000/dat-hang-thanh-cong/50761/"

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    7 × locator resolved to <html lang="vi">…</html>
      - unexpected value "http://localhost:8000/dat-hang-thanh-cong/50761/"
  - Test timeout of 30000ms exceeded.

...
- Name: account.spec.ts >> User Account >> should update profile
- Location: tests\account.spec.ts:36:7
...
Call log:
  - navigating to "http://localhost:8000/dang-nhap/", waiting until "load"

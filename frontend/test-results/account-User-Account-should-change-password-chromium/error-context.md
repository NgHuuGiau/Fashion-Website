...
- Name: account.spec.ts >> User Account >> should change password
- Location: tests\account.spec.ts:63:7
...
- generic [active] [ref=f1e1]:
  ...
  - generic [ref=f1e225]:
    - generic [ref=f1e226]:
      - generic [ref=f1e227]: ÁO
      - generic [ref=f1e228]:
        - paragraph [ref=f1e229]: Áo Cardigan Len Loose
        - paragraph [ref=f1e230]: Ai đó ở Buôn Ma Thuột vừa đặt 680.000đ · 33 phút trước
    - button "Đóng thông báo" [ref=f1e231] [cursor=pointer]: ×
  - dialog [aria-hidden] [ref=f1e232]:
    - generic [ref=f1e233]:
      - heading [level=3] [ref=f1e234]: Giỏ hàng (0)
      - button [ref=f1e235] [cursor=pointer]: ×
    - generic [ref=f1e237]:
      - generic [ref=f1e238]:
        - generic [ref=f1e239]: Tạm tính
        - strong [ref=f1e240]: 0đ
      - generic [ref=f1e241]:
  ...
  - dialog [ref=f1e244]:
    - generic [ref=f1e245]:
      - generic [ref=f1e246]:
        - strong [ref=f1e247]: Chúng tôi sử dụng cookie
      ...
      - generic [ref=f1e248]:
        - button "Tùy chỉnh" [ref=f1e249] [cursor=pointer]
        - button "Chấp nhận tất cả" [ref=f1e250] [cursor=pointer]
```
